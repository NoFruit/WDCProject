...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      header.innerHTML = header.innerHTML + '<div class="sc-actions"><span class="sc-return-today ">ToDay</span></div>';
        ...
        if (data) {
          daysElement.forEach(function (v, i) {
            ...
            if (data[year + '-' + currentmonth + '-' + day]) {
              ...
              v.title = data[year + '-' + currentmonth + '-' + day].title;
              
              if(!v.querySelector('.date-title')){
                var div = document.createElement('div')
                div.className="date-title"
                div.innerHTML = `<span data-id="${data[year + '-' + currentmonth + '-' + day].id}" class="date-title-delete">×</span>${data[year + '-' + currentmonth + '-' + day].title}`;
                v.append(div)
              }
            } else {
